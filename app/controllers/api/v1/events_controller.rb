class Api::V1::EventsController < Api::BaseController
  ...
  def sanitize_performance_payload(params)
...

    {
      ...
      sql_queries_count: parse_int(params[:sql_queries_count] || params["sql_queries_count"] || md[:sql_queries_count] || md["sql_queries_count"]),
      sql_queries: params[:sql_queries] || params["sql_queries"] || md[:sql_queries] || md["sql_queries"],
      user_id: params[:user_id] || params["user_id"],
      environment: params[:environment] || params["environment"] || "production",
      release_version: params[:release_version] || params["release_version"],
